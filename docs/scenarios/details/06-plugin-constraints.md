...
```bash
harnessdeck layer attach my-setup formatter@team-marketplace --type plugin --version "^2.1.0"
harnessdeck layer detach my-setup formatter@team-marketplace --type plugin
