# Scenario 10: Export or import a plugin as a portable bundle
...
```bash
harnesstap migrate export ./my-setup.harnesstap.toml --plugin my-setup
harnesstap migrate export ./team.harnesstap.toml --plugin my-setup --embed-plugins
harnesstap migrate import ./my-setup.harnesstap.toml
```

This is the main offline plugin sharing story. Bundles carry the plugin definition
