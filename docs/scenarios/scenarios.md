...
- Repo adoption: `scan`, `apply`, `mirror`
  ([Scenarios 4](./details/04-scan-import-repo.md), [7](./details/07-preview-apply-plugin.md), [27](./details/27-project-sync.md))
- Plugin curation: `plugin create`, `plugin edit`, `plugin doctor`, `add`
  ([Scenarios 5](./details/05-build-plugin-from-resources.md), [23](./details/23-validate-plugin.md), [35](./details/35-add-skill-package.md))
- Plugin pins: `resource sync`, `plugin show`, `apply --strict-plugin-versions`
...
- Sharing: `migrate export` / `import`, `plugin pull` / `plugin publish`
  ([Scenarios 10](./details/10-export-import-plugin.md), [28](./details/28-machine-migration.md))
...
| -------- | ----- | --------- | ------ |
| [7](./details/07-preview-apply-plugin.md)  | Preview and apply a plugin                          | Common     | Shipped |
| [11](./details/11-builtin-plugin.md) | Start from a catalog baseline                      | Common     | Shipped |
...
| [38](./details/38-plugin-from-skill-package.md) | Create a plugin from a skill package          | Common     | Shipped |
...
| [25](./details/25-stack-plugins.md) | Stack multiple plugins                              | Common     | Shipped |
| [26](./details/26-plugin-from-project.md) | Turn a project's current state into a plugin        | Common     | Shipped |
...
| [40](./details/40-use-project-profile.md) | Switch repo profiles from `apm.yml` | Common | Shipped |
...
| [5](./details/05-build-plugin-from-resources.md)  | Build a reusable plugin from imported resources     | Occasional | Shipped |
| [8](./details/08-audit-plugins.md)  | Audit plugin resources and plugin pins               | Occasional | Shipped |
| [10](./details/10-export-import-plugin.md) | Export or import a plugin bundle                    | Occasional | Shipped |
...
| [16](./details/16-ci-enforcement.md) | Enforce plugin and plugin state in CI               | Occasional | Shipped |
...
| [21](./details/21-detect-drift.md) | Detect drift between project and last applied plugin | Occasional | Shipped |
| [22](./details/22-diff-plugins.md) | Diff two plugins                                    | Occasional | Shipped |
| [23](./details/23-validate-plugin.md) | Doctor-check a plugin without writing               | Occasional | Shipped |
| [24](./details/24-apply-from-url.md) | Apply a plugin directly from a URL                  | Occasional | Shipped |
| [37](./details/37-publish-profile-plugin.md) | Publish a profile plugin to the catalog        | Occasional | Shipped |
...
| [6](./details/06-plugin-constraints.md)  | Add plugin constraints to a plugin                  | Rare       | Shipped |
...
Use these when starting or adopting a repository, applying a plugin, or when
one repo needs different harness defaults than your machine-wide setup.

| Scenario | Summary |
| -------- | ------- |
| [7](./details/07-preview-apply-plugin.md) | Preview and apply a plugin to one or more target harnesses |
| [11](./details/11-builtin-plugin.md) | Start from a catalog baseline instead of building from scratch |
...
| [38](./details/38-plugin-from-skill-package.md) | Create a plugin from a skill package |
...
| [15](./details/15-subset-platforms.md) | Apply a plugin to a subset of target platforms |
| [25](./details/25-stack-plugins.md) | Stack multiple plugins in one apply |
| [26](./details/26-plugin-from-project.md) | Turn a project's current state into a plugin |
...
| [40](./details/40-use-project-profile.md) | Switch repo profiles from `apm.yml` |

---

## Occasional

Reach for these during initial setup, when curating plugins, when sharing
...
| [5](./details/05-build-plugin-from-resources.md) | Build a reusable plugin from imported resources |
| [8](./details/08-audit-plugins.md) | Audit plugin resources and plugin pins |
| [10](./details/10-export-import-plugin.md) | Export or import a plugin as a portable bundle |
...
| [16](./details/16-ci-enforcement.md) | Enforce plugin and plugin state in CI |
...
| [21](./details/21-detect-drift.md) | Detect drift between project files and the last applied plugin |
| [22](./details/22-diff-plugins.md) | Diff two plugins (or a plugin vs an imported bundle) |
| [23](./details/23-validate-plugin.md) | Doctor-check a plugin without writing to disk |
...
| Scenario | Summary |
| -------- | ------- |
| [6](./details/06-plugin-constraints.md) | Add plugin constraints to a plugin |
