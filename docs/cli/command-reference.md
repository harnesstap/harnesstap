...
- `preset list`
- `preset show <name>`
- `preset add [preset] [selector] --type <type>`
- `preset remove [preset] [selector] --type <type>`
- `preset delete [name]`
- `preset export <preset>`
- `preset import <file>`
- `preset search <query>`
- `preset install <org>/<library>[@version]`
...
- `preset add --type <resource|skill|instruction|plugin|preset-dependency>`
- `preset add --version <constraint>`
- `preset export --embed-plugins`
- `preset install --as <name>`
