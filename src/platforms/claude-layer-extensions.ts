...
import type { ClaudeLayerConfig, SerializedFile } from "../types.js";
...
/**
 * Merge Claude marketplace and plugin layer config into serialized files.
 */
export function applyClaudeLayerExtensions(
