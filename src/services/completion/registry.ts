...
const FLAG_PROVIDERS: FlagRegistry = {
  ...
  "lock export:o": [completeFilePath],
  "lock export:project": [completeDirectoryPath],
  ...
  "audit:policy": [completeFilePath],
  "approve:project": [completeDirectoryPath],
  "deny:project": [completeDirectoryPath],
  "policy explain:project": [completeDirectoryPath],
